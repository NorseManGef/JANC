  ...
  programs = {
    ...
    bash = {
      ...
      shellAliases = {
        ...
        nswitch-server-upgrade = "cd /home/norsemangef/nixos-server && nix flake update && nixos-rebuild --flake .#server --target-host server@server --sudo --ask-sudo-password switch";
      };
    };
    starship = {
      enable = true;
